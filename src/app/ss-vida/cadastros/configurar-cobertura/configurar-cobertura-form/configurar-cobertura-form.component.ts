...
@Component({
  selector: 'app-configurar-cobertura-form',
  templateUrl: './configurar-cobertura-form.component.html',
  styleUrls: ['./configurar-cobertura-form.component.scss']
})
export class ConfigurarCoberturaFormComponent implements OnInit, OnDestroy {
